...
<body>
	<div class="wrapper">
		...
		{{View::make('Dashboard.sidebar.sidebar')}}
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="{{asset('img/avatars/avatar.jpg')}}" class="avatar img-fluid rounded me-1" alt="Admin Image " /> <span class="text-dark">{{Auth::user()->vendor_name}}</span>
              </a>
...
<div id="snackbar"></div>
			...
			@yield('content')
              ...
              {{View::make('Dashboard.sidebar.footer')}}
