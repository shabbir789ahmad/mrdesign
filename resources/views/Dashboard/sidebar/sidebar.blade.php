  ...
  <div class="sidebar-content js-simplebar">
	...
	<ul class="sidebar-nav">
	   ...
	   <li class="sidebar-header">
        ...
        <li class="sidebar-item">
		   <a class="sidebar-link" href="{{route('logo.index')}}">
          <i class="align-middle" data-feather="user"></i> <span class="align-middle">Logo</span>
       </a>
		</li>
	   ...
	   <li class="sidebar-item">
		...
		<li class="sidebar-item">
          ...
          <i class="align-middle" data-feather="user"></i> <span class="align-middle">Banners</span>
       </a>
		</li>
     ...
     <li class="sidebar-header">
		...
		<li class="sidebar-item">
		   <a class="sidebar-link" href="{{route('color.index')}}">
            <i class="align-middle" data-feather="user"></i> <span class="align-middle">Color</span>
           </a>
		</li>
    ...
    <li class="sidebar-item">
		...
		<li class="sidebar-item">
           ...
           <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Supplier</span>
         </a>
		</li>
					<li class="sidebar-item">
